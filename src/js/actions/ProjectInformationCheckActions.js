...
import { ALL_BOOKS } from '../common/BooksOfTheBible';
// actions
  ...
  return ((dispatch, getState) => {
    if (inStepper) {
      ...
      if (bookId !== originalBook) {
        dispatch(AlertModalActions.openOptionDialog(translate('projects.project_already_identified', { originalBook: ALL_BOOKS[originalBook], suggestedBook: ALL_BOOKS[bookId] }), (res) => {
